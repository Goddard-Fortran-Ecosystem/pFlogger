...
module FTL_StringVec_mod
   ...
   public :: StringVec
   public :: StringVecIter
   public :: StringVecReverseIter
   ! external functions
   public :: swap
   ...
   type :: StringVec
      ...
      type(String), allocatable :: elements(:)
   ...
   type StringVecIter
      type(String), pointer :: elements(:) => null()
   ...
   end type StringVecIter

   type StringVecReverseIter
      type(String), pointer :: elements(:) => null()
      integer :: index = UNINITIALIZED
   contains
   ...
   end type StringVecReverseIter


   interface StringVec
      module procedure constructor_empty
   end interface StringVec
...
!----------------------------------------------
   subroutine copyVector(this, other)
      class (StringVec), intent(inout) :: this
      type (StringVec), intent(in) :: other
...
!----------------------------------------------
   integer function getSize(this) 
      class (StringVec), intent(in) :: this
...
!---------------------------------------------------
   function at(this, i) result(ptr)
      class (StringVec), target, intent(in) :: this
      integer, intent(in) :: i
      type(String), pointer :: ptr
...
!-----------------------------------------------------------------
   function data(this) result(d)
      class (StringVec), target :: this
      type(String), pointer :: d(:)
...
!---------------------------------------------------
   ...
   function erase(this, position) result(iter)
      type (StringVecIter) :: iter
      class (StringVec), target, intent(inout) :: this
      type (StringVecIter), intent(in) :: position

      type(String), pointer :: p, q
...
!---------------------------------------------------
   subroutine push_back_alt(this, value)
      ...
      call this%push_back(String(value))
...
!---------------------------------------------------
   subroutine insert_alt(this, i, value)
      ...
      call this%insert(i, String(value))
...
!---------------------------------------------------
   subroutine swapVector(this, a)
      type (StringVec), intent(inout) :: this
      type (StringVec), intent(inout) :: a
...
!------------------------------------------------------
   function rbegin(this) result(iter)
      class (StringVec), target, intent(in) :: this
      type (StringVecReverseIter) :: iter
...
!-----------------------------------------------------
      function get(this) result(ptr)
         type(String), pointer :: ptr
         class (StringVecIter), intent(in) :: this
      ...
      subroutine next(this)
         class (StringVecIter), intent(inout) :: this
      ...
      logical function equalIters(this, other)
         class (StringVecIter), intent(in) :: this
         class (StringVecIter), intent(in) :: other
      ...
      function getRIter(this) result(ptr)
         class (StringVecReverseIter), intent(in) :: this
         type(String), pointer :: ptr
      ...
      subroutine rNext(this)
         class (StringVecReverseIter), intent(inout) :: this
         this%index = this%index - 1
      ...
      logical function equalRIters(this, other)
         class (StringVecReverseIter), intent(in) :: this
         class (StringVecReverseIter), intent(in) :: other
